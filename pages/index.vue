<template>
    <v-app>
        <v-main>
            <carousel autoplay loop autoplay-hover-pause :per-page="perPage"
                :autoplay-timeout="autoplayTimeout" :pagination-enabled="paginationEnabled">
                <slide v-for="(cover, index) in covers" :key="index" class="
            tw-flex
            tw-flex-col
            tw-items-center
            tw-justify-center
                    ...
                    <div class="tw-mt-10">
                        <v-dialog v-model="modalVideo">
                            ...
                            <div class="tw-aspect-w-16 tw-aspect-h-9">
                                <iframe v-if="modalVideo"
                                    src="https://www.youtube.com/embed/keVtH-IzQCQ" frameborder="0"
