    ...
    <v-main>
      ...
      <div class="main-container tw-mx-auto">
        ...
        <div class="tw-grid tw-gap-4 lg:tw-gap-8">
          <div
            v-if="getJobs === null"
            class="tw-w-5/6 mx-auto tw-p-6 tw-border-l-4 tw-border-blue-500 bg-light"
          >
            <div class="tw-text-xl tw-mb-3">
              Thank you for your interest in joining CSI.
            </div>
            <div>
              At this time, we do not have any current openings available.<br />
              However, we encourage you to utilize the
              <b>CLICK TO APPLY</b> button to submit your resume for future
              consideration.<br />
              We are always on the lookout for talented individuals, and your
              application will be carefully reviewed when a suitable opportunity
              arises.<br />
