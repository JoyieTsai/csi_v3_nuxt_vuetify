        ...
        <v-main>
          ...
          backgroundImage: `url(images/covers/${category}/${coverimg})`,
                ...
                <div class="main-container tw-mx-auto">
                    <div class="tw-flex tw-text-white tw-mt-4 md:tw-mt-8 xl:tw-mt-10 tw-cursor-pointer"
                        @click="goToPrev()">
                        <img :src="require('~/assets/icons/icon-back.svg')" alt="back"
                    ...
                    <div
                        ...
                        <div class="tw-flex tw-flex-col tw-items-center">
                            <ShareNetwork v-for="network in networks" :key="network.network"
                                ...
                                <img :src="require('@/assets/icons/' + network.icon)"
                                    alt="Social" />
                            </ShareNetwork>
                        </div>
                    </div>
                        ...
                        <div
                            ...
                            <div v-for="(item, i) in relatedProducts" :key="i"
                                ...
                                <div class="tw-flex-none tw-flex tw-items-center tw-justify-center">
                                    <img :src="require('~/assets/duotone/' + item.icon)" alt=""
...
.news-body {
    ...
    blockquote {
        ...
        &::before {
            content: '';
            background: url('../../assets/vectors/testimonial-quotes.svg')
                no-repeat;
        ...
        &::after {
            content: '';
            background: url('../../assets/vectors/testimonial-vector.svg')
                no-repeat;
            background-size: contain;
            position: absolute;
            bottom: -32px;
