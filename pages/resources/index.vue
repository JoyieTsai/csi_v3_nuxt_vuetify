            ...
            <div id="News" class="main-container tw-mx-auto tw-mb-12 xl:tw-mb-28">
                ...
                <v-container fluid pa-0>
                    <div class="tw-w-80 tw-ml-auto">
                        <v-text-field v-model="keyword" height="36" placeholder="Search"
                            prepend-inner-icon="mdi-magnify" clear-icon="mdi-close" clearable
                            class="tw-text-lg"></v-text-field>
                    </div>
                    <v-row>
                        <v-col xs="12" sm="3" md="3" lg="2"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <v-radio-group v-model="radioGroup">
                                            <div v-for="(tag, index) in tags.type" :key="index"
                                                class="tw-flex tw-mb-1">
                                                <v-radio color="primary" :value="tag.value"
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div v-for="(tag, index) in tags.solution" :key="index">
                                            <v-checkbox v-model="selected" color="primary"
                                                :label="tag.name" :value="tag.value" hide-details
                        ...
                        <v-col xs="12" sm="9" md="9" lg="10">
                            <v-data-iterator :items="filterArticles"
                                :items-per-page.sync="itemsPerPage" :footer-props="{
                                ...
                                <template v-slot:default="props">
                                    <div
                                        ...
                                        <div v-for="item in props.items" :key="item.name"
                                            ...
                                            <v-img v-if="item.cover"
                                                :src="'images/news/' + item.cover"
                                                aspect-ratio="1.9"></v-img>
                                            <div
