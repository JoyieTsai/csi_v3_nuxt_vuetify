<template>
  <v-app>
    <v-main id="story">
      <!-- Cover -->
      <div class="hero-section md:tw-items-center" :style="{
        ...
        <div class="tw-flex tw-flex-col md:tw-flex-row">
          ...
          <div class="
            ...
            <img class="
                ...
                tw-max-h-64
                md:tw-max-h-max
              " src="images/company-photo.png" alt="CSI" />
          </div>
        </div>
      </div>
      <OurMission :missions="missions" :benefits="benefits" class="tw-my-10 xl:tw-my-28" />
      <!-- Tagline -->
      ...
      <div id="contact" class="bg-primary-light bg-contact-full tw-py-8 xl:tw-py-16">
...
export default {
  data: () => ({
    ...
    benefits: {
      ...
      items: [
        {
          icon: 'csi-icon-limited_expertise_outline',
        ...
        {
          icon: 'csi-icon-relationship_outline',
        ...
        {
          icon: 'csi-icon-innovation_outline',
        ...
        {
          icon: 'csi-icon-cost_efficient_outline',
