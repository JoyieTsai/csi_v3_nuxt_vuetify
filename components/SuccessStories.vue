...
<template>
  <div class="tw-mx-auto deco-hexagon-1">
    <div
      class="tw-flex tw-flex-wrap tw-justify-center tw-relative tw-z-10"
      ...
      <div class="tw-px-5 md:tw-px-10 lg:tw-w-2/3 xl:tw-w-1/2">
        ...
        >
          ...
          <div
            ...
            v-html="superscriptTM(getLatestArticles.title)"
          ></div>
        </div>
            ...
            <slide v-for="(item, i) in getLatestArticles.testimonials" :key="i">
              <div class="tw-flex tw-flex-col tw-self-center">
                <div
                  ...
                  v-html="superscriptTM(item.body)"
                ></div>
                <div
      ...
      >
        ...
        >
          <v-img
            ...
            aspect-ratio="1.9"
          ></v-img>
          <div class="tw-text-lg" v-html="superscriptTM(art.title)"></div>
        </div>
      </div>
    </div>
  </div>
