...
<template>
  <div class="main-container tw-mx-auto">
    <div class="tw-grid lg:tw-grid-cols-2">
      <div
        class="bg-primary tw-flex tw-flex-col tw-justify-center tw-p-6 xl:tw-p-12"
      >
        <div
          class="tw-text-white tw-text-lg lg:tw-text-xl xl:tw-text-2xl tw-text-center tw-mx-5 lg:tw-mx-10 tw-mb-5"
        >
          {{ data.desc }}
        </div>
        ...
        <lottie
          ...
          @animCreated="handleAnimation($event, 'dataAnim')"
        />
        <lottie
          v-else-if="id === 'low-code'"
          class="tw-w-full"
          :options="lottieOptions.clipLowcode"
          @animCreated="handleAnimation($event, 'lowcodeAnim')"
        />
      </div>
      <div class="steps tw-flex tw-flex-col">
        <div
          ...
          :key="index"
          class="tw-px-6 lg:tw-px-12 xl:tw-px-24 tw-py-5 tw-flex-1 steps-item tw-flex tw-flex-col tw-justify-center"
        >
