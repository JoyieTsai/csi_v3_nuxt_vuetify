...
<template>
  <div class="main-container tw-mx-auto">
    ...
    <div class="
        ...
        tw-mt-12 tw-mb-20
      ">
      <div v-for="(dir, i) in directors" :key="i" class="
        ...
        <div @click="openModel(dir)">
          <div>
            <v-img :src="'images/team/' + dir.src" aspect-ratio="1" cover class="tw-mx-auto team-avatar" />
          </div>
          <div class="tw-p-3">
            <div class="
                team-title
            ...
            <div class="
                ...
                hover:hidden
                xl:tw-h-10
              " v-html="$options.filters.positionSplit(dir.position)"></div>
            <div class="
                team-desc
    ...
    <div class="header-2 tw-text-center">Product Management Team</div>
    <div class="
        tw-grid tw-grid-cols-2
        sm:tw-grid-cols-3
        xl:tw-grid-cols-4
        ...
        tw-mt-12 tw-mb-20
      ">
      <div v-for="(pm, j) in pms" :key="j" class="
          tw-text-center tw-bg-white tw-cursor-pointer tw-shadow-md
          hover:tw-shadow-xl
          tw-relative
          zoomin
          ani-avatar
        ">
        <div @click="openModel(pm)">
          <div>
            <v-img :src="'images/team/' + pm.src" aspect-ratio="1" cover class="tw-mx-auto team-avatar" />
          </div>
          <div class="tw-p-3">
            <div class="
                team-title
    ...
    <div class="
        ...
        tw-mt-12 tw-mb-20
      ">
      <div v-for="(am, j) in ams" :key="j" class="
          tw-text-center tw-bg-white tw-cursor-pointer tw-shadow-md
          hover:tw-shadow-xl
          tw-relative
          zoomin
        ...
        <div @click="openModel(am)">
          <div>
            <v-img :src="'images/team/' + am.src" aspect-ratio="1" cover class="tw-mx-auto team-avatar" />
          </div>
          <div class="tw-p-3">
            <div class="
                team-title
    ...
    <div class="tw-mt-36 tw-mb-6 lg:tw-mb-12 lg:tw-w-4/5 xl:tw-w-3/4 tw-mx-auto" :data-aos="$vuetify.breakpoint.smAndDown ? '' : 'fade-up'"
      ...
      <div v-for="(adv, k) in advisor" :key="k">
        <div v-if="$vuetify.breakpoint.mdAndUp" class="
          ...
          <div class="tw-absolute tw--top-28">
            <img :src="'images/team/' + adv.src" alt="" class="tw-w-48 lg:tw-w-64" />
          </div>
          <div class="tw-p-8 lg:tw-p-16">
            ...
            <div class="
              ...
              " v-html="$options.filters.positionSplit(adv.position)"></div>
            <div class="tw-mt-8 tw-text-base lg:tw-text-lg" v-html="adv.desc"></div>
          </div>
        </div>
    ...
    <!-- Show Detail -->
    <v-dialog v-model="modalDetail" content-class="tw-bg-white tw-m-0 tw-overflow-x-hidden" @ok="() => (modalDetail = false)">
      ...
      <v-sheet id="scrolling-techniques-7" max-height="600">
        <div class="tw-flex tw-flex-col sm:tw-flex-row tw-px-5 md:tw-px-8 tw-pb-8">
