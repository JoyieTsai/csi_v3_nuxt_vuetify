      ...
      ">
        ...
        ">
                <div @click="openModel(dir)">
                    <div>
                        <v-img :src="'images/team/' + dir.src" aspect-ratio="1" cover
      ...
      ">
        ...
        ">
                <div @click="openModel(pm)">
                    <div>
                        <v-img :src="'images/team/' + pm.src" aspect-ratio="1" cover
                            class="tw-mx-auto team-avatar" />
                    </div>
                    <div class="tw-p-3">
                        <div class="
      ...
      ">
        ...
        ">
                <div @click="openModel(am)">
                    <div>
                        <v-img :src="'images/team/' + am.src" aspect-ratio="1" cover
                            class="tw-mx-auto team-avatar" />
                    </div>
                    <div class="tw-p-3">
                        <div class="
        ...
        <div class="tw-mt-36 tw-mb-6 lg:tw-mb-12 lg:tw-w-4/5 xl:tw-w-3/4 tw-mx-auto"
            :data-aos="$vuetify.breakpoint.smAndDown ? '' : 'fade-up'" data-aos-duration="1500">
        ...
        <!-- Show Detail -->
        <v-dialog v-model="modalDetail" content-class="tw-bg-white tw-m-0 tw-overflow-x-hidden"
            ...
            <v-sheet id="scrolling-techniques-7" max-height="600">
                <div class="tw-flex tw-flex-col sm:tw-flex-row tw-px-5 md:tw-px-8 tw-pb-8">
                    <div class="sm:tw-w-1/4">
                        <img :src="'images/team/' + popSrc" alt=""
