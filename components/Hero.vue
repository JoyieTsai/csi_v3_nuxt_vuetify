<template>
    <div>
        <div class="hero-section md:tw-items-center tw-relative md:tw--mb-12 xl:tw--mb-16 2xl:tw--mb-20"
            :style="{
        ...
        <!-- Book a Demo -->
        <v-dialog v-model="modalBookaDemo" overlay-color="white"
            content-class="accent tw-p-5 lg:tw-p-10" @ok="() => (modalBookaDemo = false)">
            <BookDemo />
        </v-dialog>
    </div>
</template>
