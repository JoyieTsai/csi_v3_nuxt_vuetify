<template>
  <div>
    <div
      class="hero-section md:tw-items-center tw-relative md:tw--mb-12 xl:tw--mb-16 2xl:tw--mb-20"
      :style="{
    ...
    >
      <div class="main-container tw-mx-auto tw-flex tw-flex-col md:tw-flex-row">
        <div
          class="tw-flex-1 sm:tw-flex-auto tw-w-full sm:tw-mr-10 lg:tw-mr-0 sm:tw-w-3/5 lg:tw-flex-1 tw-flex tw-items-center md:tw-mb-10"
        >
          <div class="lg:tw-mb-10">
            ...
            <div
              class="tw-text-2.5xl sm:tw-text-3xl xl:tw-text-4xl 2xl:tw-text-5xl tw-font-semibold tw-leading-snug tw-my-3"
            >
            ...
            <div v-if="btns" class="tw-flex tw-mt-5 md:tw-my-5">
              <button
                class="btn-lg btn-primary hover:tw-shadow-xl tw-mr-3 md:tw-mr-5 tw-mb-3 md:tw-mb-0"
              ...
              <button
                v-if="brochure"
                class="btn-lg btn-primary-inverse hover:tw-shadow-xl tw-mb-3 md:tw-mb-0"
    ...
    <div class="bg-primary-light">
      <div
        class="main-container tw-mx-auto tw-py-12 xl:tw-py-20 d-flex tw-flex-col lg:tw-flex-row"
      >
        <div class="tw-w-full xl:tw-w-3/4 white--text">
          <div
            class="tw-text-lg md:tw-text-xl xl:tw-text-2xl tw-mb-2 tw-font-semibold"
          >
...
export default {
  props: {
    ...
    btns: { type: Boolean, default: false },
  },
  data: () => ({
