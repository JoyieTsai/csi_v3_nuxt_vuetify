              ...
              ">
                        ...
                        <div class="tw-mt-4">
                            <div class="tw-flex tw-items-center">
                                <img :src="require('@/assets/icons/icon-msg.svg')"
                  ...
                  ">Send a message</a>
                            ...
                            <div class="tw-flex tw-items-center tw-mt-3">
                                <img :src="require('@/assets/icons/icon-phone.svg')"
            ...
            <div class="w-teambox">
                <div class="tw-bg-blue-500 tw-bg-opacity-20 w-teambox">
                    <div class="tw-p-4 md:tw-p-5 xl:tw-p-10 text-primary">
                        <img :src="require('@/assets/vectors/quotes.svg')" alt=""
                            class="tw-mb-5 tw-w-10 xl:tw-w-14" />
                        <div :class="[
                ...
                'tw-font-semibold tw-leading-snug',
                        ...
                        <div v-if="quote.author"
                            class="tw-mt-3 tw-text-base xl:tw-text-lg tw-text-right">
                            - {{ quote.author }}
                        </div>
                    </div>
                </div>
