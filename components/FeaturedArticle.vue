...
<template>
    <div class="main-container tw-mx-auto">
        <div class="2xl:tw-mx-20 tw-relative tw-mb-10">
            ...
            <!-- Testimonial -->
            <div class="tw-relative tw-shadow-lg tw-bg-white w-quotes tw-px-5 lg:tw-px-10 tw-pt-10 tw-pb-5 tw-z-10"
                data-aos="fade-right" data-aos-duration="1500" data-aos-once="true">
                <carousel loop :per-page="perPage" pagination-enabled :navigate-to="currentIndex"
                    ...
                    <slide v-for="(item, i) in getLatestArticles.testimonials" :key="i"
                        ...
                        <div class="tw-flex tw-flex-col tw-self-center md:tw-mx-5">
                            ...
                            <div class="tw-text-xs md:tw-text-sm xl:tw-text-base tw-opacity-60"
                                v-html="item.agency"></div>
                        </div>
                    </slide>
                </carousel>
            </div>
