      ...
      >
        <div>
          ...
          <div class="tw-flex tw-justify-center">
            ...
            <a
              class="tw-ml-3 btn-circle twitter-color"
              href="https://twitter.com/CSI_InfoShare"
              target="_blank"
            >
              <img :src="require('@/assets/icons/icon-x.svg')" alt="X" />
            </a>
            <a
              class="tw-ml-3 btn-circle linkedin-color"
              href="https://www.linkedin.com/company/csi-technology-group/?viewAsMember=true"
              target="_blank"
            >
              <img
                :src="require('@/assets/icons/icon-linkedin.svg')"
                alt="Linkedin"
              />
            </a>
          </div>
        ...
        <!-- VERIFIED Seal -->
        <div
          class="tw-flex tw-justify-center tw-gap-5 tw-flex-row tw-mt-20 tw-mb-5"
        >
          <!-- <a href="//www.dandb.com/verified/business/576765318/" target="_blank"> -->
          <img
            src="images/verified_logo.png"
            alt="VERIFIED Seal"
            class="tw-h-20"
          />
          <!-- </a> -->
          <div>
            <img
              src="images/soc2_logo.jpg"
              alt="Soc2"
              class="tw-mx-auto tw-h-20"
            />
          </div>
        </div>
      </div>
      <!-- Headings -->
      <div class="footer-list tw-flex-auto">
        <div
