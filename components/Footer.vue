    ...
    <div class="tw-pb-5 tw-pt-10 lg:tw-pt-16 footer-line">
        <div class="tw-flex tw-items-stretch tw-flex-col lg:tw-flex-row">
            ...
            <div
                ...
                <div>
                    <img src="images/csi-logo-vertical.svg" alt="CSI Technology Group"
                        class="tw-mb-8 tw-mx-auto tw-h-20 md:tw-h-28" />
                    <!-- Social media -->
                    <div class="tw-flex tw-justify-center">
                        <a class="btn-circle fb-color"
                            href="https://www.facebook.com/CSITechnologyGroup/?view_public_for=243043239075210"
                            target="_blank">
                            <img :src="require('@/assets/icons/icon-fb.svg')" alt="Facebook" />
                        </a>
                        <a class="tw-ml-3 btn-circle twitter-color"
                            href="https://twitter.com/CSI_InfoShare" target="_blank">
                            <img :src="require('@/assets/icons/icon-twitter.svg')" alt="Twitter" />
                        </a>
                        <a class="tw-ml-3 btn-circle linkedin-color"
                            href="https://www.linkedin.com/company/csi-technology-group/?viewAsMember=true"
                            target="_blank">
                            <img :src="require('@/assets/icons/icon-linkedin.svg')"
                                alt="Linkedin" />
                        </a>
                    </div>
                    <!-- Address -->
                ...
                <div class="tw-my-8 md:tw-my-16">
                    <a href="//www.dandb.com/verified/business/576765318/" target="_blank">
                        <img src="images/verified_logo.png" alt="VERIFIED Seal"
                            class="tw-mx-auto tw-h-16 md:tw-h-20" />
                    </a>
                </div>
            </div>
            <!-- Headings -->
            <div class="tw-flex-auto">
                    ...
                    <div v-for="(data, i) in datas" :key="i" class="tw-flex-auto tw-mt-5">
                        <div>
                            ...
                            <div v-for="(link, j) in data.links" :key="j">
                                <div v-if="link.sub"
                                    class="tw-font-semibold tw-mb-3 text-primary-light">
                                    {{ link.sub }}
                                </div>
                                <div v-for="(tab, k) in link.tabs" :key="k"
                                    class="item-link tw-pr-5">
                                    <nuxt-link v-if="tab.id && tab.id !== 'resource'"
                                        :to="'/' + data.category + '/' + tab.id"
                                        class="tw-block footer-link tw-text-sm xl:tw-text-base tw-mb-2">
                                        {{ tab.title }}
                                    </nuxt-link>
                                    <a v-else-if="tab.id === 'resource'"
                                        class="tw-block footer-link tw-text-sm xl:tw-text-base tw-mb-2"
                                        @click="routerToArticle(tab.query)">
                                        {{ tab.title }}
                                    </a>
                                    <nuxt-link v-else :to="'/' + data.category"
                ...
                <div
                    ...
                    <div
                        ...
                        © 2023 CSI Technology Group. All Rights Reserved.
                    </div>
