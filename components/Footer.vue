    ...
    <div class="tw-flex tw-items-stretch tw-flex-col lg:tw-flex-row">
      ...
      <div class="tw-flex tw-flex-col tw-px-12 xl:tw-px-16 2xl:tw-px-20 tw-justify-between tw-mt-5">
        <div>
          ...
          <div class="tw-flex tw-justify-center">
            <a class="btn-circle fb-color"
              href="https://www.facebook.com/CSITechnologyGroup/?view_public_for=243043239075210" target="_blank">
            ...
            <a class="tw-ml-3 btn-circle linkedin-color"
              href="https://www.linkedin.com/company/csi-technology-group/?viewAsMember=true" target="_blank">
        ...
        <div class="tw-flex tw-justify-center tw-gap-5 tw-flex-row tw-mt-20 tw-mb-5">
          ...
          <img src="images/verified_logo.png" alt="VERIFIED Seal" class="tw-h-20" />
          <!-- </a> -->
          <div>
              ...
              <div v-for="(link, j) in data.links" :key="j">
                ...
                <div v-for="(tab, k) in link.tabs" :key="k" class="item-link tw-pr-5">
                  <nuxt-link v-if="tab.id && tab.id !== 'resource'" :to="'/' + data.category + '/' + tab.id"
                    ...
                    v-html="superscriptTM(tab.title)"></nuxt-link>
                  ...
                  <nuxt-link v-else :to="'/' + data.category"
                    class="tw-block footer-link tw-text-sm lg:tw-text-base tw-mb-2" v-html="tab.title"></nuxt-link>
                </div>
              </div>
            </div>
          </div>
